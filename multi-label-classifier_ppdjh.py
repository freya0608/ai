#https://blog.csdn.net/MiaoB226/article/details/89504131?spm=1001.2101.3001.6650.1&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-1.pc_relevant_default&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-1.pc_relevant_default&utm_relevant_index=2
...
image_Root_Dir = r'E:/Reproduction_Related_work'
...
def get_fabricDataset_labels(labels):
    """返回Fashion-MNIST数据集的文本标签

    Defined in :numref:`sec_fashion_mnist`"""
    text_labels = ["cashmere","nylon","wool","polyester"]
...
class my_Data_Set(nn.Module):
    def __init__(self, csv_file, transform=None, target_transform=None, loader=None):
        ...
        with open(csv_file, 'r') as f:
            ...
            # for row in list(reader):
                ...
                labels.append([float(l) for l in row[5:len(row)]])
                # print('lables',labels)
            ...
            #     line.rstrip()
            #     information = line.split()
            #     images.append(information[1])
            #     # 将标签信息由str类型转换为float类型
            #     labels.append([l for l in information[5:len(information)]])
            self.images = images
            self.labels = labels
    ...
    def __getitem__(self, item):
        ...
        # 读入图像信息
        # print('imageName888', image_Root_Dir+imageName)
        image = self.loader(image_Root_Dir+imageName)
        # 处理图像数据
...
train_Data = my_Data_Set(r'E:/Reproduction_Related_work/train.csv', transform=data_transforms['train'], loader=Load_Image_Information)
print('train_Data',train_Data)
val_Data = my_Data_Set(r'E:/Reproduction_Related_work/val.csv', transform=data_transforms['val'], loader=Load_Image_Information)
